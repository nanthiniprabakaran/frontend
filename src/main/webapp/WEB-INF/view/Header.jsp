...
<li class="active"><a href="<c:url value='/ContactUs'></c:url>"><span class="glyphicon glyphicon-earphone"></span>ContactUs</a></li>
  ...
  <li class="active"><a href="<c:url value='/admin/getCategory'></c:url>"><span class="glyphicon glyphicon-plus"></span>Add Category</a></li>
  <li class="active"><a href="<c:url value='/admin/getSupplier'></c:url>"><span class="glyphicon glyphicon-plus"></span>Add supplier</a></li>
    </security:authorize>
